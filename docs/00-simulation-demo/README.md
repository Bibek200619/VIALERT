...
Simulation-specific logic lives in `frontend/src/features/simulation/`, including a
pure reducer/route-effect engine and deterministic tests. `backend/server-node` provides
