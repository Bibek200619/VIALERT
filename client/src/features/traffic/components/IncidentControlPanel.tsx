...
export function IncidentControlPanel({ city, incidents, selected, onAdd, onRemove }: {
  city: CityData;
  ...
  return <section className="panel traffic-incident-panel" aria-labelledby="traffic-incident-title">
